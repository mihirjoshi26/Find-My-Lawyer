<?php
	...
	<table border='1' width='590' align='center' cellpadding='2px' cellspacing='2' >
			<tr>
				...
				<a href='http://localhost/Findmylawyer/login.php'>Login Here</a>
			</td>
		</tr>
	</table>";
    $mailMsg = $message;
	...
	$mail ->Port = 465;
	$mail ->IsHTML(true);
	$mail ->Username = "levelxero0@gmail.com";
	$mail ->Password = "levelxero0123";
	$mail->setFrom('levelxero0@gmail.com', 'Account Information');
